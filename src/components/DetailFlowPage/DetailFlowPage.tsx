  ...
  const tmpMockData: Record<string, DetailDataValue> = {
    reporting: {
      ...
      paymentData: [
        ...
        {
          label: 'CF / Partita IVA Pagatore',
          value: 'BNCMRA82B42C933X (Persona fisica)'
        },
    ...
    receipt: {
      ...
      paymentData: [
        ...
        {
          label: 'CF / Partita IVA',
          value: 'PLRSRA82B42C933X (Persona fisica)'
        },
        { label: 'Attestante', value: 'POSTMAN_TEST' },
        { label: 'IUD', value: '000a99aa114e6b142268f27abb8b347c37d' },
        { label: 'IUR', value: 'hR3sT2uG888KkKK' }
    ...
    treasury: [
      ...
      { label: 'Codice Provvisorio', value: '' },
      {
        label: 'Causale',
        value:
          'ACCREDITO INCASSI DEBITORE 321/PUR/LGPE-RIVERSAMENTO/URI/2024-09-03PPAYITR1XXX-S50033300001'
      }
    ]
  };

  const data = tmpMockData[category ?? ''] as
    | Record<string, Array<DetailData>>
    | Array<DetailData>;
