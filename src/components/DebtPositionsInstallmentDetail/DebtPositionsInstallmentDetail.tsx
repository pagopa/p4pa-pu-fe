...
export const DebtPositionsInstallmentDetail = () => {
  ...
  const installmentDetailData: DetailDataValue = {
    summaryData: [
      ...
      { label: t('commons.fiscalCodeorVatExecutor'), value: `${installment?.debtor?.fiscalCode} ${getEntityTypeLabel(installment?.debtor?.entityType)}` },
    ...
    paymentData: [
      ...
      { label: t('commons.fiscalCodeorVatExecutor'), value: `${installment?.payer?.fiscalCode} ${getEntityTypeLabel(installment?.payer?.entityType)}` },
