...
import InstallmentFieldV2 from '../Installment/InstallmentFieldV2';
import type {
  BeneficiaryData,
...
import { BeneficiaryFieldRef } from '../Beneficiary/BeneficiaryFieldV2';
...
const Step3V2 = ({ data, setData, onBack }: Props) => {
